...
> solution mà ta muốn gắn vô để thử) có dạng là [a1 a2]ᵀ *
> e^λt
>
>
>
...
> là một con số nào đó, gọi là λ, nhưng vì ta cần
> nghiệm là một vector, nên ta nhân nó với vector x (cũng
> không biết cần phải tìm), để có (e^λt)*x
>
>
>
...
>
>
> Vế trái, là [x y]ᵀ' nên ta cần lấy đạo hàm của trial solution,
> kết quả sẽ là λ * [a1, a2]ᵀ * e^λt (không có gì khó,
...
###### Eigenvalues in Differential Systems

<p align="center"><kbd><img src="assets/4d8lg8im8jw.png" width="80%"></kbd></p>

> [!NOTE]
> Và hai vế đều có e^λt ta cancel đi. Để còn lại là
> λ [a1 a2]ᵀ = [matrix hệ số] [a1 a2]ᵀ
>
>
>
...
###### Linear Systems Eigenvalue Method
...
> [!NOTE]
> Thế thì để giải, ông sẽ coi λ như parameter và khi
...
> làm chính là muốn tìm λ để matrix singular, khi đó
> nullspace sẽ khác {0} và giúp A'x = 0 có solution khác 0
>
>
>
> Và cũng có thể thấy A' đây chính là A-λI, và cái
> phương trình det A' = 0 để tìm nullspace space của A'
> chính là ta đang giải characteristic equation để tìm 
> nullspace của A-λI, và vector trong nullspace
> của A-λI cũng chính là eigenvector của A
...
> [!NOTE]
> Và thế λ = -1 vào để tìm a1, a2. Gs lưu ý ta rằng
...
> tìm λ để det A-λI = 0 là để matrix đó singular,
> khi đó nullspace của nó mới tồn tại nonzero vector, cũng
> có nghĩa là tồn tại bộ hệ số khiến combine các columns 
> của A-λI thành 0, và đó cũng là eigenvector của A.
>
>
>
> Và đây, tìm ra λ=-1 chính là để matrix [A-λI]
...
> là [-1 2]ᵀ và [2 -4] thành 0 được. Chứ nếu không, hai cột
...
> λ xong, gắn vào mà thấy hệ hai phương trình này
...
> của nullspace (của A-λI) và nó cũng chính là
> eigenvector của A
...
>
>
> Ta có hệ hai phương trình với ẩn là λ, a1, a2
>
>
>
> Để rồi coi λ như parameter, ta chuyển thành hệ
...
> [!NOTE]
> Và gs cho biết (mà ta cũng đã biết từ 1806) λ được
...
> equation trở thành Aα = λα (chính là cái mà hồi nãy
...
>
>
> Và Aα = λα với kiến thức 1806 thì đây chính là phương
...
> là equation cho det của A-λ × I = 0 để khiến (theo
> 1806) nó singular ⇒ tồn tại nonzero vector trong
> nullspace (của A-λI) ⇒ và nó chính là
> eigenvector của A.
