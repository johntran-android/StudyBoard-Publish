...
**🔗 See also:** [Phân bố Gamma ngược](#node-rpp5mf7) · [Chuyển đổi PDF biến ngẫu nhiên](#node-hbxp4xf) · [Bổ đề Chi-square](./53_sampling_from_the_normal_distribution.md#node-udtt0nq)
...
**🔗 See also:** [Phân phối Chi-squared từ Y=X^2](#node-f14tr9i) · [Biến đổi CDF sang Unif(0,1)](#node-gk21cay) · [Biến đổi tích phân xác suất](./56_generating_random_sample.md#node-ezy1q8o)
