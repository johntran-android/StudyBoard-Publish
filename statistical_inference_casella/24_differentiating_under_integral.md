...
>
>
> ⇨ d/dλ [ (e^-x/λ) / λ) ] = { d/dλ e^(-x/λ) . λ  -  e^(-x/λ) d/dλ [λ] } / λ²
>
>
>
> =  { d/d(-x/λ) e^(-x/λ) . d/dλ (-x/λ) . λ  -  e^(-x/λ) . 1 } / λ²
>
>
>
> =  { e^(-x/λ) . -x d/dλ (1/λ) . λ  -  e^(-x/λ) } / λ²
>
>
>
> =  { e^(-x/λ) . -x (-1/λ²) . λ  -  e^(-x/λ) } / λ²
>
>
>
> =  { e^(-x/λ) . x (1/λ)  -  e^(-x/λ) } / λ²
...
>
>
> Do đó (1) = ∫0:inf x^n (1/ λ²) [ (x/λ)  -  1] e^(-x/λ) ] dx 
>
>
>
> = ∫0:inf [ x^n (1/ λ²) (x/λ) e^(-x/λ)  -  x^n (1/ λ²) 1 e^(-x/λ) ] dx 
>
>
>
> = ∫0:inf [ x^n (1/ λ²) (x/λ) e^(-x/λ) ] dx  - ∫0:inf [ x^n (1/ λ²) e^(-x/λ) ] dx 
>
>
>
> = (1/ λ²) ∫0:inf [ x^n+1 (1/λ) e^(-x/λ) ] dx  - (1/ λ) ∫0:inf [ x^n (1/λ)e^(-x/λ) ] dx 
>
>
>
> = **EX^(n+1) / λ²  -  EX^n/ λ**
...
>
>
> x^n  ∂/∂λ [ (1/λ) e^-x/λ ]  = x^n (1/ λ²) [ (x/λ)  -  1] e^(-x/λ)
>
>
>
> = **[ x^n e^(-x/λ) / λ²] [ (x/λ)  -  1]
...
>
>
> = | [ x^n e^(-x/λ) / λ²] [ (x/λ)  -  1] | = [ x^n e^(-x/λ) / λ²] | [ (x/λ)  -  1] |  (vì cái cục trước đó dương cả
> rồi)≤ [ x^n e^(-x/λ) / λ²] [ (x/λ)  +  1]  |
>
>
>
> CHƯA HIỂU TẠI SAO
...
>
>
> d/dλ EX^n = EX^(n+1) / λ²  -  EX^n/ λ
>
>
>
> ⇔ EX^(n+1) / λ² =  EX^n/ λ + d/dλ EX^n
>
>
>
