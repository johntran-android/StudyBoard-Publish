...
>
>
> Cho g(x) = (x - μ)^2 / σ², μ = EX, σ² - VarX, viết constant r ở dạng t^2
> cho tiện
>
>
>
...
>
>
> P((X - μ)^2 / σ² ≥ t^2) ≤ E[(X - μ)^2 / σ²] / t^2
>
>
>
> Xét vế phải E[(X - μ)^2 / σ²] = E[(X^2 + μ² - 2Xμ) / σ²]
>
>
>
> = [E(X^2) + Eμ² - 2μEX)] / σ²
...
>
>
> ⇨ (1) ⇔ P((X - μ)^2 / σ² ≥ t^2) ≤ 1 / t^2 (2)
>
>
>
> Mà xét event (X - μ)^2 / σ² ≥ t^2
>
>
>
...
> Đầu tiên ta sẽ học về Bổ đề Stein's: Nói rằng cho X ~ n(θ, σ²) và hàm g
> khả vi thỏa E|g'(X)| < inf. Khi đó E[g(X)(X - θ)] = σ²Eg'(X)
>
>
>
> Thử tính E[g(X)(X - θ)]
...
>
>
> =  ∫-inf:inf g(x)(x - θ) [1/σ√2π] e^[-(x - θ)^2/2σ²] dx
>
>
>
> = [1/σ√2π]  ∫-inf:inf g(x) (x - θ) e^[-(x - θ)^2/2σ²] dx
>
>
>
> Đặt u = g(x), du = g'(x)dx. 
...
>
>
> = -σ² d/d [-(x - θ)^2/2σ²] e^[-(x - θ)^2/2σ²] . d/d(x - θ) [-(x - θ)^2/2σ²] . d/dx (x - θ)
>
>
>
> = -σ² e^[-(x - θ)^2/2σ²] . (1/2σ²) [-2(x - θ)] . 1
>
>
>
> = (x - θ) e^[-(x - θ)^2/2σ²] 
...
>
>
> ⇨ ∫-inf:inf g(x) (x - θ) e^[-(x - θ)^2/2σ²] dx
>
>
>
> = g(x) [-σ² e^[-(x - θ)^2/2σ²] ] |-inf:inf - ∫-inf:inf [-σ² e^[-(x - θ)^2/2σ²] ] g'(x)dx. 
>
>
>
> = - σ² g(x) e^[-(x - θ)^2/2σ²]  |-inf:inf - ∫-inf:inf [-σ² e^[-(x - θ)^2/2σ²] ] g'(x)dx.
>
>
>
> Và xét cái term đầu:
...
>
>
> x → +inf ⇨ e^[-(x - θ)^2/2σ²] →  - σ² g(x) e^[-(x - θ)^2/2σ²]   → 0
>
>
>
...
>
>
> Term sau: ∫-inf:inf [-σ² e^[-(x - θ)^2/2σ²] ] g'(x)dx.
>
>
>
> = σ² ∫-inf:inf g'(x) e^[-(x - θ)^2/2σ²] dx = **σ² Eg'(X)
>
>
>
