...
>
>
> ... = 1 * 1/[(√2π)σ] exp [ - (x^2 - 2xμ + μ²) / 2σ² ]   |  khai triển (x - μ)^2 ra thôi
>
>
>
> = 1 * 1 / [(√2π)σ] exp [ - x^2 / 2σ² + 2xμ / 2σ² **- μ² / 2σ²** ]  | chia mỗi hạng tử cho
> 2σ²
>
>
>
> = 1 * 1 / [(√2π)σ] exp [ - x^2 / 2σ² + 2xμ / 2σ² ] exp ( **- μ² / 2σ²** )  | e^(a + b) = e^a
> e^b
>
>
>
> = 1 * 1 / [(√2π)σ] exp ( - μ² / 2σ² ) exp [ - x^2 / 2σ² + xμ / σ² ]  | đưa exp ( - μ² / 2σ²
> )
>
>
>
...
>
>
> **= 1 * 1 / [(√2π)σ] exp ( - μ² / 2σ² ) exp [ (1/σ²) (-x^2/2) + (μ / σ²) (x) ]**   ⇨ Có nghĩa
...
>
>
> c(θ) = **1 / [(√2π)σ] exp (- μ² / 2σ² )**   -inf < μ < inf, σ > 0
>
>
>
> w1(μ, σ) = 1 / σ²  | σ > 0
...
>
>
> **Ý là, domain của hàm c(θ), cụ thể ở đây là 1 / [(√2π)σ] exp (- μ² / 2σ² ) sẽ chỉ
...
>
>
> Cụ thể là = 1 * {1 / [(√2π)σ] exp ( - μ² / 2σ² ) } exp [ (1/σ²) (-x^2/2) + (μ /
> σ²) (x) ]
>
>
>
...
>
>
> Như vậy là ta sẽ đặt η1 = w1(μ, σ) = 1/σ²; η2 = w2(μ, σ) = μ/σ²
>
>
>
> ⇨ √η1 = 1/σ ⇨ σ = 1 / √η1;
...
>
>
> Thay vào η2 = μ/σ² ⇔ η2 = μ η1 ⇨ μ = η2 / η1
>
>
>
...
>
>
> 1 * {1 / [(√2π) (1 / √η1)] exp ( - μ² / 2σ² ) } exp [ η1 (-x^2/2) + η2 (x) ]
>
>
>
> = 1 * {1 / [ √2π / √η1] } exp ( - μ² / 2σ² ) } exp [ η1 (-x^2/2) + η2 (x) ]
>
>
>
> = (√η1 / √2π) exp ( - μ² / 2η1 ) } exp [ - (η1x^2/2) + η2 x ]
>
>
>
