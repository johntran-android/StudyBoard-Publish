...
**🔗 See also:** [Khái niệm hội tụ](#node-0pl1tf2) · [Luật số lớn yếu](#node-j5m3pa1) · [Hội tụ hầu chắc](#node-jayixv4) · [Hội tụ xác suất thống kê](./101_point_estimation.md#node-4pzd0to)
...
**🔗 See also:** [Hội tụ xác suất](#node-ybskg1i) · [WLLN và nhất quán](#node-fvhedp5) · [Bất đẳng thức Markov và chứng minh](./36_inequalities.md#node-u9zgfoi) · [Tính chất trung bình phương sai mẫu](./52_of_random_variables_from_a_random_sample.md#node-411jdqg)
...
**🔗 See also:** [WLLN và nhất quán](#node-fvhedp5) · [Định lý ánh xạ liên tục](#node-4nopzwp) · [Tạo biến ngẫu nhiên mũ](./56_generating_random_sample.md#node-bxd38ye)
...
**🔗 See also:** [Định luật số lớn mạnh](#node-vfj18l8) · [Hội tụ theo phân phối](#node-ok89lxf) · [Phương pháp mô phỏng WLLN](./56_generating_random_sample.md#node-jeizj20)
...
**🔗 See also:** [Hội tụ xác suất sang phân phối](#node-f944h0i) · [CLT - Định lý giới hạn trung tâm](#node-32vkewg) · [Theorem 10.1.12 (Asymptotic efficiency of MLEs)](./101_point_estimation.md#node-n1mqtrr)
...
**🔗 See also:** [Hội tụ xác suất và phân phối](#node-wqcasc6) · [Định lý Giới hạn Trung tâm](#node-efueime) · [Phương pháp Delta 1/Xbar](#node-1zfrnml) · [Stronger Central Limit Theorem](#node-yngnkwh) · [Theorem 10.1.12 (Asymptotic efficiency of MLEs)](./101_point_estimation.md#node-n1mqtrr)
...
**🔗 See also:** [CLT - Định lý giới hạn trung tâm](#node-32vkewg) · [Proof of Theorem 5.5.14](#node-yzn3dv1) · [MGF của aX+b](./23_mgf.md#node-4ypjp34) · [Các định lý độc lập n biến](./46_multi_variate_distribution.md#node-151qbd1)
...
**🔗 See also:** [Định lý Giới hạn Trung tâm](#node-efueime) · [Khai triển Taylor MGF Moment](#node-o94eaek) · [Biến đổi PDF Location-Scale](./35_location_and_scale_families.md#node-cs2rm3i) · [MGF của aX+b](./23_mgf.md#node-4ypjp34)
...
**🔗 See also:** [Định lý Taylor](#node-pv5v3rp) · [Xấp xỉ Chuẩn Nhị thức Âm](#node-z9v0fvw) · [CLT - Định lý giới hạn trung tâm](#node-32vkewg) · [MLE of e-lambda with Delta Method](./101_point_estimation.md#node-jiyzyog)
...
**🔗 See also:** [Xấp xỉ Chuẩn Nhị thức Âm](#node-z9v0fvw) · [Ước lượng Odds và Delta Method](#node-q6etf0o) · [Theorem 10.1.12 (Asymptotic efficiency of MLEs)](./101_point_estimation.md#node-n1mqtrr)
...
**🔗 See also:** [Công thức phương sai hàm](#node-pkuyin2) · [Xấp xỉ kì vọng phương sai](#node-mpw7a57) · [Phương sai tiệm cận và giới hạn](./101_point_estimation.md#node-62aug4x)
...
**🔗 See also:** [Xấp xỉ kì vọng phương sai](#node-mpw7a57) · [Phương pháp Delta 1/Xbar](#node-1zfrnml) · [10.1.3 Calculations and Comparisons](./101_point_estimation.md#node-iwgmm5t)
...
**🔗 See also:** [Đạo hàm riêng tỉ lệ](#node-475o694) · [CLT ước lượng tỉ số](#node-w9x29p6) · [Xấp xỉ kỳ vọng Taylor](#node-o8nor00) · [Đặc điểm phân phối Cauchy](./22_expected_value.md#node-d6kf31i)
