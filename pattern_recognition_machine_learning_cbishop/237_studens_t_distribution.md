...
>
>
> Vậy ở đây, ta nhớ lại chút, với Bayesian approach, để infer θ, ta coi nó như random variable, có prior distribution π(θ) và dùng Bayes theorem để xây dựng posterior distribution của θ: π(θ| 𝐱) = f(𝐱|θ) π(θ) / f(𝐱). Thế thì, nếu nhìn lại, thì tử số của bên phải chính là joint pdf của 𝐗 và θ: f(𝐱, θ). Nên nếu marginal cái này over θ, ta sẽ có marginal pdf f(𝐱) (và chia cho f(𝐱) ở dưới, sẽ ra 1, để hoàn toàn khớp với việc ta marginal cái bên trái π(θ|𝐱) over θ, cũng phải ra 1, vì đây là một valid pdf)
>
>
>
...
>
>
> .. = ∫(√τ/√2π) exp\[-τ(x-μ)²/2\] b^a exp(-bτ) τ^(a-1) / Γ(a) dτ
>
>
>
> = ∫ \[b^a exp(-bτ) τ^(a-1) / Γ(a)\] (τ/2π)^(1/2) exp\[-τ(x-μ)²/2\] dτ
>
>
>
>  = ∫ \[b^a / Γ(a)\] \[(1/2π)^(1/2)\] τ^(1/2) τ^(a-1) exp\[-τ(x-μ)²/2-bτ\] dτ
>
>
>
> = ∫ \[b^a / Γ(a)\] (1/2π)^(1/2) τ^(a-1/2) exp{-τ\[(x-μ)²+2b\]/2} dτ
>
>
>
...
>
>
> với c = \[b^a / Γ(a)\] (1/2π)^(1/2), α = a+1/2, β = \[(x-μ)²+2b\]/2
>
>
>
...
>
>
> Thay α = a+1/2, β = \[(x-μ)²+2b\]/2 vào
>
>
>
> = \[b^a / Γ(a)\] (1/2π)^(1/2) \[Γ(a+1/2)/{\[(x-μ)²+2b\]/2}^(a+1/2)\] 
>
>
>
> = \[b^a / Γ(a)\] (1/2π)^(1/2) \[1/{\[(x-μ)²+2b\]/2}^(a+1/2)\] Γ(a+1/2)
>
>
>
> = \[b^a / Γ(a)\] (1/2π)^(1/2) \[{\[(x-μ)²+2b\]/2}^(-a-1/2)\] Γ(a+1/2)
>
>
>
> = \[b^a / Γ(a)\] (1/2π)^(1/2) \[\[(x-μ)²/2+b\]^(-a-1/2)\] Γ(a+1/2)
>
>
>
> = \[b^a / Γ(a)\] (1/2π)^(1/2) \[\[b + (x-μ)²/2\]^(-a-1/2)\] Γ(a+1/2) → kết quả trong sách 2.158
>
>
>
>  ----
...
>
>
> .. = \[(a/λ)^a / Γ(ν/2)\] (1/2π)^(1/2) \[\[a/λ + (x-μ)²/2\]^(-ν/2-1/2)\] Γ(ν/2+1/2) 
>
>
>
> = \[Γ(ν/2+1/2) / Γ(ν/2)\] (1/2π)^(1/2) (a/λ)^a \[\[a/λ + (x-μ)²/2\]^(-ν/2-1/2)\] 
>
>
>
> = \[Γ(ν/2+1/2) / Γ(ν/2)\] (1/2π)^(1/2) (a/λ)^a (a/λ)^(-ν/2-1/2) × \[1 + λ(x-μ)²/2a\]^(-ν/2-1/2)\] 
>
>
>
> = \[Γ(ν/2+1/2) / Γ(ν/2)\] (1/2π)^(1/2) (a/λ)^(a-ν/2-1/2) × \[1 + λ(x-μ)²/ν\]^(-ν/2-1/2)\] 
>
>
>
> = \[Γ(ν/2+1/2) / Γ(ν/2)\] (1/2π)^(1/2) (a/λ)^(ν/2-ν/2-1/2) × \[1 + λ(x-μ)²/ν\]^(-ν/2-1/2)\] 
>
>
>
> = \[Γ(ν/2+1/2) / Γ(ν/2)\] (1/2π)^(1/2) (a/λ)^(-1/2) × \[1 + λ(x-μ)²/ν\]^(-ν/2-1/2)\] 
>
>
>
> = \[Γ(ν/2+1/2) / Γ(ν/2)\] (1/2π)^(1/2) (λ/a)^(1/2) × \[1 + λ(x-μ)²/ν\]^(-ν/2-1/2)\] 
>
>
>
> = \[Γ(ν/2+1/2) / Γ(ν/2)\] (1/2π)^(1/2) (2λ/ν)^(1/2) × \[1 + λ(x-μ)²/ν\]^(-ν/2-1/2)\] 
>
>
>
> = \[Γ(ν/2+1/2) / Γ(ν/2)\] (λ/πν)^(1/2) × \[1 + λ(x-μ)²/ν\]^(-ν/2-1/2)\]  → 2.159
>
>
>
