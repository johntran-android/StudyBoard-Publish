...
**`~12,013 notes` · `~17,397 screenshots` · `17 notebooks`**
...
### 📂 Numerical Optimization_J.Nocedal (📝 373 Notes | 📸 520 Screenshots)
...
- [10.3 Algorithms for nonlinear least-squares problem](numerical_optimization_jnocedal/103_algorithms_for_nonlinear_least_squares_problem.md) — `8n / 14i`
...
### 📂 Pattern Recognition Machine Learning_C.Bishop (📝 325 Notes | 📸 467 Screenshots)
...
- [3.2.0 The Bias-Variance Decomposition](pattern_recognition_machine_learning_cbishop/320_the_bias_variance_decomposition.md) — `4n / 4i`
...
### 📂 Statistical Inference - Casella (📝 820 Notes | 📸 1074 Screenshots)
...
- [10.1 Point Estimation](statistical_inference_casella/101_point_estimation.md) — `36n / 42i`
