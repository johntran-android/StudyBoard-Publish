...
**`~12,027 notes` · `~17,425 screenshots` · `17 notebooks`**
...
### 📂 Numerical Optimization_J.Nocedal (📝 375 Notes | 📸 524 Screenshots)
...
- [10.3 Algorithms for nonlinear least-squares problem](numerical_optimization_jnocedal/103_algorithms_for_nonlinear_least_squares_problem.md) — `10n / 18i`
...
### 📂 Statistical Inference - Casella (📝 821 Notes | 📸 1075 Screenshots)
...
- [10.1 Point Estimation](statistical_inference_casella/101_point_estimation.md) — `37n / 43i`
