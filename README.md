...
**`~12,014 notes` · `~17,399 screenshots` · `17 notebooks`**
...
### 📂 Numerical Optimization_J.Nocedal (📝 374 Notes | 📸 522 Screenshots)
...
- [10.3 Algorithms for nonlinear least-squares problem](numerical_optimization_jnocedal/103_algorithms_for_nonlinear_least_squares_problem.md) — `9n / 16i`
