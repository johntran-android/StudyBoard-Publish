...
**`~12,329 notes` · `~17,814 screenshots` · `18 notebooks`**
...
`416 notes · 629 screenshots · 63 sections`
...
| [4.2.1 Continuous inputs](pattern_recognition_machine_learning_cbishop/421_continuous_inputs.md) | 1 | 4 |
...
<!-- group: Probability & Statistics -->
`868 notes · 1,130 screenshots · 50 sections`
...
| [10.4 Interval Estimation](statistical_inference_casella/104_interval_estimation.md) | 4 | 5 |
