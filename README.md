...
**`~12,024 notes` · `~17,418 screenshots` · `17 notebooks`**
...
### 📂 Pattern Recognition Machine Learning_C.Bishop (📝 333 Notes | 📸 483 Screenshots)
...
- [3.3 Bayesian Linear Regression](pattern_recognition_machine_learning_cbishop/33_bayesian_linear_regression.md) — `4n / 4i`
