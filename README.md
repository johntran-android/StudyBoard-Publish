...
**`~12,077 notes` · `~17,493 screenshots` · `17 notebooks`**
...
### 📂 Numerical Optimization_J.Nocedal (📝 392 Notes | 📸 550 Screenshots)
...
- [12.1 Examples](numerical_optimization_jnocedal/121_examples.md) — `7n / 12i`
...
### 📂 Statistical Inference - Casella (📝 838 Notes | 📸 1094 Screenshots)
...
- [10.2 Robustness](statistical_inference_casella/102_robustness.md) — `12n / 13i`
