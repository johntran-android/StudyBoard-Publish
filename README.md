...
**`~12,025 notes` · `~17,421 screenshots` · `17 notebooks`**
...
### 📂 Pattern Recognition Machine Learning_C.Bishop (📝 334 Notes | 📸 486 Screenshots)
...
- [3.3 Bayesian Linear Regression](pattern_recognition_machine_learning_cbishop/33_bayesian_linear_regression.md) — `5n / 7i`
