...
**`~12,368 notes` · `~17,876 screenshots` · `18 notebooks`**
...
`435 notes · 663 screenshots · 70 sections`
...
| [4.3.2 Logistic regression](pattern_recognition_machine_learning_cbishop/432_logistic_regression.md) | 5 | 10 |
| [4.3.3 Iterative reweighted least squares](pattern_recognition_machine_learning_cbishop/433_iterative_reweighted_least_squares.md) | 3 | 4 |
