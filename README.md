...
**`~12,299 notes` · `~17,757 screenshots` · `18 notebooks`**
...
<!-- group: Optimization -->
`407 notes · 579 screenshots · 33 sections`
...
| [12.5  Second-Order Conditions](numerical_optimization_jnocedal/125_second_order_conditions.md) | 10 | 19 |
...
`398 notes · 592 screenshots · 57 sections`
...
| [4.1.3 Least squares for classification](pattern_recognition_machine_learning_cbishop/413_least_squares_for_classification.md) | 6 | 7 |
...
<!-- group: Probability & Statistics -->
`861 notes · 1,122 screenshots · 49 sections`
...
| [10.3 Hypothesis Testing](statistical_inference_casella/103_hypothesis_testing.md) | 19 | 22 |
