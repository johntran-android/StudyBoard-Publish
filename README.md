...
**`~12,242 notes` · `~17,662 screenshots` · `18 notebooks`**
...
| [12.5  Second-Order Conditions](numerical_optimization_jnocedal/125_second_order_conditions.md) | 1 | 2 |
...
`366 notes · 532 screenshots · 49 sections`
...
| [3.5.1 Evaluation of the evidence function](pattern_recognition_machine_learning_cbishop/351_evaluation_of_the_evidence_function.md) | 1 | 2 |
...
<!-- group: Probability & Statistics -->
`845 notes · 1,104 screenshots · 49 sections`
...
| [10.3 Hypothesis Testing](statistical_inference_casella/103_hypothesis_testing.md) | 3 | 4 |
