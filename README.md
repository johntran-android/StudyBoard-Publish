...
**`~12,362 notes` · `~17,862 screenshots` · `18 notebooks`**
...
`433 notes · 656 screenshots · 70 sections`
...
| [4.3.1 Fixed basis functions](pattern_recognition_machine_learning_cbishop/431_fixed_basis_functions.md) | 2 | 4 |
| [4.3.2 Logistic regression](pattern_recognition_machine_learning_cbishop/432_logistic_regression.md) | 5 | 6 |
| [4.3.3 Iterative reweighted least squares](pattern_recognition_machine_learning_cbishop/433_iterative_reweighted_least_squares.md) | 1 | 2 |
...
<!-- group: Probability & Statistics -->
`873 notes · 1,135 screenshots · 50 sections`
...
| [10.4 Interval Estimation](statistical_inference_casella/104_interval_estimation.md) | 9 | 10 |
