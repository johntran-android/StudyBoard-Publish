...
**`~12,261 notes` · `~17,693 screenshots` · `18 notebooks`**
...
<!-- group: Optimization -->
`402 notes · 566 screenshots · 33 sections`
...
| [12.5  Second-Order Conditions](numerical_optimization_jnocedal/125_second_order_conditions.md) | 5 | 6 |
...
`375 notes · 551 screenshots · 51 sections`
...
| [3.5.3 Effective number of parameters](pattern_recognition_machine_learning_cbishop/353_effective_number_of_parameters.md) | 3 | 8 |
...
<!-- group: Probability & Statistics -->
`851 notes · 1,112 screenshots · 49 sections`
...
| [10.3 Hypothesis Testing](statistical_inference_casella/103_hypothesis_testing.md) | 9 | 12 |
