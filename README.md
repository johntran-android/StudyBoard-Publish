...
**`~12,052 notes` · `~17,459 screenshots` · `17 notebooks`**
...
### 📂 Numerical Optimization_J.Nocedal (📝 388 Notes | 📸 541 Screenshots)
...
- [10.3 Algorithms for nonlinear least-squares problem](numerical_optimization_jnocedal/103_algorithms_for_nonlinear_least_squares_problem.md) — `14n / 23i`
- [10.4 Orthogonal Distance Regression (bỏ qua)](numerical_optimization_jnocedal/104_orthogonal_distance_regression_b_qua.md) — `1n / 1i`
- [12.0 Theory of Constrained Optimization](numerical_optimization_jnocedal/120_theory_of_constrained_optimization.md) — `5n / 8i`
- [12.1 Examples](numerical_optimization_jnocedal/121_examples.md) — `3n / 3i`
...
### 📂 Pattern Recognition Machine Learning_C.Bishop (📝 340 Notes | 📸 498 Screenshots)
...
- [1.2.1&2 Probability densities & Expectations Covariances](pattern_recognition_machine_learning_cbishop/1212_probability_densities_expectations_covariances.md) — `14n / 18i`
- [1.2.3 Bayesian probabilities](pattern_recognition_machine_learning_cbishop/123_bayesian_probabilities.md) — `11n / 14i`
- [1.2.4 The Gaussian distribution](pattern_recognition_machine_learning_cbishop/124_the_gaussian_distribution.md) — `10n / 14i`
- [1.2.5 Curve fitting re-visited.](pattern_recognition_machine_learning_cbishop/125_curve_fitting_re_visited.md) — `9n / 11i`
- [1.2.6 Bayesian curve fitting](pattern_recognition_machine_learning_cbishop/126_bayesian_curve_fitting.md) — `6n / 7i`
- [1.3 Model Selection](pattern_recognition_machine_learning_cbishop/13_model_selection.md) — `5n / 6i`
- [1.4 The Curse
Of Dimensionality](pattern_recognition_machine_learning_cbishop/14_the_curse_of_dimensionality.md) — `6n / 15i`
- [1.5 Decision Theory](pattern_recognition_machine_learning_cbishop/15_decision_theory.md) — `29n / 41i`
- [1.6 Information Theory](pattern_recognition_machine_learning_cbishop/16_information_theory.md) — `24n / 32i`
- [1.7 Excersices](pattern_recognition_machine_learning_cbishop/17_excersices.md) — `1n / 0i`
- [2.0 Intro](pattern_recognition_machine_learning_cbishop/20_intro.md) — `4n / 5i`
- [2.1 Binary Variables](pattern_recognition_machine_learning_cbishop/21_binary_variables.md) — `16n / 24i`
- [2.2 Multinomial Variables](pattern_recognition_machine_learning_cbishop/22_multinomial_variables.md) — `7n / 10i`
- [2.3.0 Gaussian Distribution](pattern_recognition_machine_learning_cbishop/230_gaussian_distribution.md) — `16n / 27i`
- [2.3.1 Conditional Gaussian](pattern_recognition_machine_learning_cbishop/231_conditional_gaussian.md) — `6n / 7i`
- [2.3.2 Marginal Gaussian](pattern_recognition_machine_learning_cbishop/232_marginal_gaussian.md) — `3n / 7i`
- [2.3.3 Bayes's theorem for Gaussian variables](pattern_recognition_machine_learning_cbishop/233_bayess_theorem_for_gaussian_variables.md) — `6n / 9i`
- [2.3.4 Maximum Likelihood for Gaussian](pattern_recognition_machine_learning_cbishop/234_maximum_likelihood_for_gaussian.md) — `4n / 4i`
- [2.3.5 Sequential  estimation](pattern_recognition_machine_learning_cbishop/235_sequential_estimation.md) — `5n / 8i`
- [2.3.6 Bayes inference for the Gaussian](pattern_recognition_machine_learning_cbishop/236_bayes_inference_for_the_gaussian.md) — `8n / 13i`
- [2.3.7 Studen's t-distribution](pattern_recognition_machine_learning_cbishop/237_studens_t_distribution.md) — `4n / 9i`
- [2.3.8 Periodic variables](pattern_recognition_machine_learning_cbishop/238_periodic_variables.md) — `7n / 17i`
- [2.3.9 Mixtures of Gaussians](pattern_recognition_machine_learning_cbishop/239_mixtures_of_gaussians.md) — `5n / 9i`
- [2.4 The Exponential Family](pattern_recognition_machine_learning_cbishop/24_the_exponential_family.md) — `6n / 9i`
- [2.4.1 Maximum likelihood & sufficient statistic](pattern_recognition_machine_learning_cbishop/241_maximum_likelihood_sufficient_statistic.md) — `4n / 4i`
- [2.4.4 Conjugate prior](pattern_recognition_machine_learning_cbishop/244_conjugate_prior.md) — `1n / 1i`
- [2.4.3 Non-informative priors](pattern_recognition_machine_learning_cbishop/243_non_informative_priors.md) — `7n / 8i`
- [2.5 Non-parametric model](pattern_recognition_machine_learning_cbishop/25_non_parametric_model.md) — `5n / 5i`
- [2.5.1 Kernel density estimators](pattern_recognition_machine_learning_cbishop/251_kernel_density_estimators.md) — `7n / 9i`
- [2.5.2 Nearest-neighbour methods](pattern_recognition_machine_learning_cbishop/252_nearest_neighbour_methods.md) — `5n / 10i`
- [3.1.0 Linear Regression and Basis Functions](pattern_recognition_machine_learning_cbishop/310_linear_regression_and_basis_functions.md) — `7n / 9i`
...
- [3.3.2 Predictive distribution](pattern_recognition_machine_learning_cbishop/332_predictive_distribution.md) — `4n / 8i`
- [3.3.1 Bayesian Linear Regression](pattern_recognition_machine_learning_cbishop/331_bayesian_linear_regression.md) — `7n / 11i`
...
### 📂 Statistical Inference - Casella (📝 829 Notes | 📸 1084 Screenshots)
...
- [10.1 Point Estimation](statistical_inference_casella/101_point_estimation.md) — `42n / 49i`
- [10.2 Robustness](statistical_inference_casella/102_robustness.md) — `3n / 3i`
