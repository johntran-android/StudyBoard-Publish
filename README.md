...
**`~12,001 notes` · `~17,381 screenshots` · `17 notebooks`**
...
### 📂 Pattern Recognition Machine Learning_C.Bishop (📝 324 Notes | 📸 467 Screenshots)
...
- [3.2.0 The Bias-Variance Decomposition](pattern_recognition_machine_learning_cbishop/320_the_bias_variance_decomposition.md) — `3n / 4i`
...
### 📂 Statistical Inference - Casella (📝 807 Notes | 📸 1059 Screenshots)
...
- [10.1 Point Estimation](statistical_inference_casella/101_point_estimation.md) — `28n / 32i`
